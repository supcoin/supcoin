...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Supcoin Core supcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  supcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded supcoin transaction") + "\n" +
              "  supcoin-tx [options] -create [commands]   " + _("Create hex-encoded supcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded supcoin transaction
