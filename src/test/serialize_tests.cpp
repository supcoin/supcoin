...
BOOST_AUTO_TEST_CASE(floats)
{
    ...
    BOOST_CHECK(Hash(ss.begin(), ss.end()) == uint256("8e8b4cf3e4df8b332057e3e23af42ebc663b61e0495d5e7e32d85099d7f3fe0c"));
...
BOOST_AUTO_TEST_CASE(doubles)
{
    ...
    BOOST_CHECK(Hash(ss.begin(), ss.end()) == uint256("43d0c82591953c4eafe114590d392676a01585d25b25d433557f0d7878b23f96"));
