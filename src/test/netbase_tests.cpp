...
{
    BOOST_CHECK(TestSplitHost("www.supcoin.org", "www.supcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.supcoin.org]", "www.supcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.supcoin.org:80", "www.supcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.supcoin.org]:80", "www.supcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4411", "127.0.0.1", 4411));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4411", "127.0.0.1", 4411));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4411", "::ffff:127.0.0.1", 4411));
    BOOST_CHECK(TestSplitHost("[::]:4411", "::", 4411));
    BOOST_CHECK(TestSplitHost("::4411", "::4411", -1));
    BOOST_CHECK(TestSplitHost(":4411", "", 4411));
    BOOST_CHECK(TestSplitHost("[]:4411", "", 4411));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4411", "127.0.0.1:4411"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4411", "[::]:4411"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
