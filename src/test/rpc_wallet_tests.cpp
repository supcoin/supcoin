// Copyright (c) 2013-2014 The Supcoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CSupcoinAddress demoAddress = CSupcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CSupcoinAddress setaccountDemoAddress = CSupcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CSupcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSupcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
