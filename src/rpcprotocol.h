...
#ifndef SUPCOIN_RPCPROTOCOL_H
#define SUPCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Supcoin is not connected
