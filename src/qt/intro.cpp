...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/supcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Supcoin Core"),
     ...
     * override -datadir in the supcoin.conf file in the default data directory
     * (to be consistent with supcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
