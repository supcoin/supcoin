...
#ifndef SUPCOIN_QT_SUPCOINUNITS_H
#define SUPCOIN_QT_SUPCOINUNITS_H
...
/** Supcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SupcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SupcoinUnits(QObject *parent);

    /** Supcoin units.
      @note Source: https://en.supcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SUP,
...
typedef SupcoinUnits::Unit SupcoinUnit;

#endif // SUPCOIN_QT_SUPCOINUNITS_H
