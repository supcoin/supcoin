...
unlocked to sign the Supcoin-Qt.app bundle.
...
allowing somebody to distribute a Supcoin-Qt.app or supcoin-qt-setup.exe with a valid
...
that the supcoin-qt.exe file inside the installer had not been tampered with.
