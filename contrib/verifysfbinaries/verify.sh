...
###   This script attempts to download the signature file SHA256SUMS.asc from supcoin.org
...
WORKINGDIR="/tmp/supcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://supcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://supcoin.org/bin/"
VERSIONPREFIX="supcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'supcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[supcoin-]<version>-[rc[0-9]] (example: supcoin-0.9.2-rc1)"
   echo "wget output:"
