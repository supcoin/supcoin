Supcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/supcoin/files/Supcoin/supcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Supcoin-Qt to crash on Windows when exiting.
