Supcoin Core version 0.9.4 is now available from:

  https://supcoin.org/bin/0.9.4/
...
this update is incompatible with the Supcoin system and could lead to consensus
forks.

Supcoin Core released binaries from https://supcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~supcoin/+archive/ubuntu/supcoin
- A third-party or self-compiled Supcoin Core

upgrade to Supcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
