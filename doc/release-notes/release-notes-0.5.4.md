Supcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/supcoin/files/Supcoin/supcoin-0.5.4/
...
http://gitorious.org/supcoin/supcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Supcoin-Qt notifications under Growl 1.3.
Increase required age of Supcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSupcoin properly when installing Supcoin-Qt over it. (Windows)
