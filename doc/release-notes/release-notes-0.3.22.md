Download URL: https://sourceforge.net/projects/supcoin/files/Supcoin/supcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SUP fee schedule (users still pay 0.01 SUP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #supcoin00 - #supcoin99
