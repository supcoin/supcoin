Supcoin Core version 0.9.2.1 is now available from:

  https://supcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SUP to 0.01 SUP
...
- Fix "Start supcoin on system login"
