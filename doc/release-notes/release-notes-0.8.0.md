Supcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/supcoin/files/Supcoin/supcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Supcoin
...
New/changed settings (command-line or supcoin.conf file)
--------------------------------------------------------
