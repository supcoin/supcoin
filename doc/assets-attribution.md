The following is a list of assets used in the supcoin source and their proper attribution.
...
* License: MIT
* Site: [https://supcointalk.org/index.php?topic=15276.0](https://supcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original supcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/supcoin.icns, src/qt/res/src/supcoin.svg,
	src/qt/res/src/supcoin.ico, src/qt/res/src/supcoin.png,
	src/qt/res/src/supcoin_testnet.png, docs/supcoin_logo_doxygen.png,
